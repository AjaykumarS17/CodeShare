...
mongoose.connect("mongodb+srv://10praveenkumar1999:unVboj1O344MGQvX@cluster0.35j26dm.mongodb.net/?retryWrites=true&w=majority", {
  ...
  new GoogleStrategy(
    {
      ...
      callbackURL: "https://codexshare-n89u.onrender.com/auth/google/callback",
...
app.get("/joinsession/:sessionid", function (req, res) {
  ...
  isJoinSession = true;
  res.redirect("https://codexshare-n89u.onrender.com/auth/google");
});
...
function startServer() {
  ...
  server.listen("https://codexshare-n89u.onrender.com" || 5000, () =>
